...
dirs = {
   'lbpm_sc3_mean': 'Sri_Lanka_lbpm_bands/',
   'lbpm_sc3_variance': 'Sri_Lanka_lbpm_bands/',
   'lbpm_sc3_skew': 'Sri_Lanka_lbpm_bands/',
   'lbpm_sc3_kurtosis': 'Sri_Lanka_lbpm_bands/',
   'lbpm_sc3_variance':'Sri_Lanka_lbpm_bands/',
   'lbpm_sc5_mean': 'Sri_Lanka_lbpm_bands/',
   'lbpm_sc5_variance': 'Sri_Lanka_lbpm_bands/',
   'lbpm_sc5_skew': 'Sri_Lanka_lbpm_bands/',
   'lbpm_sc5_kurtosis': 'Sri_Lanka_lbpm_bands/',
   'lbpm_sc5_variance':'Sri_Lanka_lbpm_bands/',
   'lbpm_sc7_mean': 'Sri_Lanka_lbpm_bands/',
   'lbpm_sc7_variance': 'Sri_Lanka_lbpm_bands/',
   'lbpm_sc7_skew': 'Sri_Lanka_lbpm_bands/',
   'lbpm_sc7_kurtosis': 'Sri_Lanka_lbpm_bands/',
   'lbpm_sc7_variance':'Sri_Lanka_lbpm_bands/'
}
...
spfeas_stats.to_csv("lbpm_stats_all.csv")
