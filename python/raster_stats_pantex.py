...
dirs = {
  'pantex_sc3_min': 'Sri_Lanka_pantex_bands/',
  'pantex_sc5_min': 'Sri_Lanka_pantex_bands/',
  'pantex_sc7_min': 'Sri_Lanka_pantex_bands/'
}
...
spfeas_stats.to_csv("pantex_stats_all.csv")
